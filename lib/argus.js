...
argus.removeNick = function (nick) {
    if (!argus.nickExists({ nick: nick })) {
        console.log(nick + ' does not exist');
    }
    
    var c = _.reject(argus.channels, function (n) {
        return n.nick == nick;
    });
